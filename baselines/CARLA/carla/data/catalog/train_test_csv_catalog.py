...
class TrainTestCsvCatalog(DataCatalog):
    """
    ...
    def __init__(
        ...
        raw = pd.concat((train_raw, test_raw), axis=0, ignore_index=True) 

        super().__init__(
            "custom", train_raw, train_raw, test_raw, scaling_method, encoding_method
        )
