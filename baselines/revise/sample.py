...
from carla.data.catalog import CsvCatalog, OnlineCatalog, DataCatalog, TrainTestCsvCatalog
...
class MyOwnModel(MLModel):
    def __init__(self, data, data_dir, info, input_shape=66, device="cpu", encoding_method="OneHot", hidden_dims=None):
        ...
        print("Loaded BB Model", model_filename)
...
def main(args):
    ...
    # dataset_test = CsvCatalog(file_path=test_set_path,
    #                 continuous=num_cols,
    #                 categorical=cat_cols,
    #                 immutables=immutable,
    #                 target=info["target_col"],
    ...
    hyperparameters = setup_catalog["recourse_methods"]["revise"]["hyperparams"]
    ...
    hyperparameters["vae_params"]["epochs"] = 1230
    ...
    rv = Revise(model, dataset, hyperparameters)
