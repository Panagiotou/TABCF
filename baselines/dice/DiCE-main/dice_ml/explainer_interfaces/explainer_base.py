...
class ExplainerBase(ABC):
    ...
    def __init__(self, data_interface, model_interface=None, data_dice_input=None):
        """Init method
    ...
    def generate_counterfactuals(self, query_instances, total_CFs,
                                 ...
                                 categorical_penalty=0.1, proximity_weight_latent=-1.0, proximity_latent_loss="L2", plausibility_weight_latent=-1.0,
                                 posthoc_sparsity_algorithm="linear", verbose=False, **kwargs):
        ...
        self._validate_counterfactual_configuration(
            ...
            posthoc_sparsity_algorithm=posthoc_sparsity_algorithm, verbose=verbose, proximity_weight=proximity_weight, proximity_weight_latent=proximity_weight_latent, proximity_latent_loss=proximity_latent_loss,
            plausibility_weight_latent=plausibility_weight_latent,
            kwargs=kwargs
        )
        ...
        for query_instance in tqdm(query_instances_list):
            ...
            res = self._generate_counterfactuals(
                ...
                verbose=verbose, proximity_weight=proximity_weight, proximity_weight_latent=proximity_weight_latent, proximity_latent_loss=proximity_latent_loss, plausibility_weight_latent=plausibility_weight_latent,
                **kwargs)
            ...
            # else:
            #     if res.final_cfs_df is not None and len(res.final_cfs_df) > 0:
            #         res.final_cfs_df = self.data_dice_input.ensure_consistent_type(
            #             res.final_cfs_df, query_instance)
